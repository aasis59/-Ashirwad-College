...
function Why_best() {
  return (
    <section className=" back_ground_one pb-20  ">
      <div className="text-center py-10 ">
        <Typography variant="h2" > Why Choose Ashirwad?</Typography>
      </div>
      <div className="grid grid-cols-1 grid-rows-1 md:grid-cols-2 md:grid-rows-2 gap-5 p-20  bg-white rounded-lg shadow-lg  page-width ">
        <div className="border  border border-gray-200 shadow-md rounded-lg p-5 ">
